...
public class SkillEditor_Content
{
    ...
    public Action<SkillEditor_Content> OnRemoveNode;
    public SkillEditor_Content(Vector2 pos, float width, float height, GUIStyle defaultStyle, GUIStyle selectStyle, Action<SkillEditor_Content> onRemoveNode, SkillInfo skill)
    {
        Skill = skill;
    ...
    public void Draw()
    {
        ...
        posY += 25;
        GUI.Label(new Rect(rect.x + 10, rect.y + posY, rect.width * 0.33f, 20), "Range");
        Skill.Range = EditorGUI.FloatField(new Rect(rect.x + rect.width * 0.33f, rect.y + posY, rect.width * 0.33f - 10, 20), Skill.Range);
        Skill.IsAutoAim = EditorGUI.ToggleLeft(new Rect(new Rect(rect.x + rect.width * 0.66f, rect.y + posY, rect.width * 0.33f - 10, 20)), "Use AIM", Skill.IsAutoAim);
        posY += 25;
