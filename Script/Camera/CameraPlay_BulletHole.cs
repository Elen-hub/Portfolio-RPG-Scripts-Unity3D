...
public class CameraPlay_BulletHole : MonoBehaviour
{
    ...
    void Start()
    {
        if (Rnd == 0) Texture2 = Resources.Load("Camera/CameraPlay_BulletHole_Anm") as Texture2D;


        if (Rnd == 1) Texture2 = Resources.Load("Camera/CameraPlay_BulletHole_Anm3") as Texture2D;
        SCShader = Shader.Find("CameraShader/BulletHole");
        cframe = 0;
    }
