...
public class CameraPlay_RainDrop : MonoBehaviour
{
   ...
   [HideInInspector] public int Count = 0;
    ...
    void Start()
    {
        ...
        Texture2 = Resources.Load("Camera/CameraPlay_Waterdrop_Anm2") as Texture2D;
        Texture3 = Resources.Load("Camera/CameraPlay_Waterdrop_Anm") as Texture2D;
        SCShader = Shader.Find("CameraShader/RainDrop");
    ...
    void Update()
    {
        ...
        if (CamTurnOff)
        {
            ...
            if (Timer < 0)
            {
                CameraMng.CurrentCamera.RainDrop_Switch = false;
                Object.Destroy(this);
            }
        }
    }
