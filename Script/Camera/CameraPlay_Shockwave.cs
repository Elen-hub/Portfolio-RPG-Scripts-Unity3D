...
public class CameraPlay_Shockwave : MonoBehaviour
{
    ...
    void Start()
    {
        Value = 0;
        Timer = 0;
        SCShader = Shader.Find("CameraShader/Shockwave");
        Texture2 = Resources.Load("Camera/CameraPlay_ShockWave_Anm") as Texture2D;
    }
...
#endif
        Texture2 = Resources.Load("CamPlay/CameraPlay_ShockWave_Anm") as Texture2D;
